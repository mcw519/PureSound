...
Usage:
  uv run python egs/rir_generation/phases/m5_calibration/scripts/classify_but_rirs.py \
      --but-root egs/rir_generation/exp/rir_realism/m5/BUT_ReverbDB \
      --out egs/rir_generation/exp/rir_realism/m5/BUT_ReverbDB_classified
"""
...
def main():
    ...
    ap.add_argument("--but-root", type=Path,
                    default=REPO_ROOT / "egs/rir_generation/exp/rir_realism/m5/BUT_ReverbDB",
                    help="extracted BUT ReverbDB root")
    ap.add_argument("--out", type=Path,
                    default=REPO_ROOT / "egs/rir_generation/exp/rir_realism/m5/BUT_ReverbDB_classified",
