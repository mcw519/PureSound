...
Usage:
    ...
    python real_rir_to_bank.py from-manifest \
        --manifest manifest.jsonl --output egs/rir_generation/exp/rir_realism/m5/real_rir_bank \
    ...
    python real_rir_to_bank.py but \
        --input /path/to/BUT_ReverbDB --output egs/rir_generation/exp/rir_realism/m5/real_rir_bank --d0 1.0
