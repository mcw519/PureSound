...
def build_presence_gate(args):
    ...
    if not getattr(args, "presence_gate", None):
        return None
    from puresound.system.presence_gate import PresenceGate
    return PresenceGate.load(args.presence_gate, b_hi=args.gate_b_hi,
                             b_lo=args.gate_b_lo, gain_floor_db=args.gate_floor_db,
