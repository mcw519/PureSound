...
def test_create_optimizer_and_scheduler_applies_lr_factors():
    ...
    optimizer, scheduler = create_optimizer_and_scheduler(
        ...
        optimizer_args=OptimizerConfig(type="AdamW", learning_rate=0.01, args={"weight_decay": 0.001}),
        scheduler_args=SchedulerConfig(type="StepLR", warmup_step=0, args={"step_size": 2, "gamma": 0.5}),
    )
